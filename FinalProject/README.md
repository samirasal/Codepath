...
This web app: **This is a socila platform where users can share content about anything related to fashion. From sharing links to videos and images. You cn also share on your social media platforms such as whatsapp, x and facebook!**
...
* [X] List anything else that you added to improve the site's functionality!
      i made a simple UI that's appealing to the user's view

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://imgur.com/a/gCP4SCH.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
